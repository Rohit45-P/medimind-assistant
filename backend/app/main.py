...
from app.routes import health_logs, public, voice_notes, emergency_alerts
...
app.include_router(emergency_alerts.router, prefix="/api/emergency", tags=["Emergency Alerts"])
